...
--- This function is available in client and server state(s)
--- 
--- Returns whether the key was down or not.--- Unlike 
--- 
--- @param key number
--- @return boolean
...
--- This function is available in client and server state(s)
--- 
--- Sets the radius that constrains the players movement.--- Works with conjunction of:
--- 
--- @param radius number
...
--- This function is available in client and server state(s)
--- 
--- Sets the maximum player speed. Player won't be able to run or sprint faster then this value.--- This also automatically sets --- This must be called on both client and server to avoid prediction errors.--- This will 
--- 
...
--- This function is available in client and server state(s)
--- 
--- Sets the maximum speed of the player. This must match with --- Doesn't seem to be doing anything on it's own, use 
--- 
--- @param maxSpeed number
