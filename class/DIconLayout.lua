...
--- This function is available in client state(s)
--- 
--- Returns whether the icon layout will stretch its height to fit all the children.--- See also 
--- 
--- @return boolean
...
--- This function is available in client state(s)
--- 
--- Returns whether the icon layout will stretch its width to fit all the children.--- See also 
--- 
--- @return boolean
...
--- This function is available in client state(s)
--- 
--- Sets the direction that it will be layed out, using the --- Currently only TOP and LEFT are supported.
--- 
...
--- This function is available in client state(s)
--- 
--- If set to true, the icon layout will stretch its height to fit all the children.--- See also 
--- 
...
--- This function is available in client state(s)
--- 
--- If set to true, the icon layout will stretch its width to fit all the children.--- See also 
--- 
