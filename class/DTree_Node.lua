...
--- Returns the indentation level of the 
--- Alias of 
--- 
--- @return number
...
--- It doesn't actually remove or unparent the panel, just removes it from the internal 
--- 
--- @param pnl Panel
...
--- Sets the parent node of this node. Not the same as 
