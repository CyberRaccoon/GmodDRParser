...
--- This hook will not be called if 
--- See 
--- 
--- @param ply Player
--- @param ent Entity
...
--- Called from 
--- This hook may not be called in gamemodes that override 
--- 
--- @param veh Vehicle
--- @param ply Player
--- @param view table
...
--- Called when a variable is edited on an Entity (called by 
--- See 
--- 
--- @param ent Entity
--- @param ply Player
...
--- Teams are created within this hook using 
...
--- Called when a key-value pair is set on an entity, either by the engine (for example when map spawns) or 
--- See 
--- See 
--- 
--- @param ent Entity
...
--- By default this function makes 
--- 
--- @param ply Player
--- @param ent Entity
--- @return boolean
...
--- Called when the mouse has been double clicked on any panel derived from CGModBase, such as the panel used by 
--- By default this hook calls 
--- 
...
--- Called whenever a players presses a mouse key on the context menu in Sandbox or on any panel derived from CGModBase, such as the panel used by 
--- See 
--- 
--- @param mouseCode number
--- @param aimVector Vector
...
--- It is recommended to use Derma and VGUI for this job instead of this hook. Called right after 
--- 
...
--- Called right before 
--- Not called when the Camera SWEP is equipped, or when the main menu is visible. 
--- See also 
--- 
...
--- Called before 
--- Just like 
--- Things rendered in this hook will 
--- 
...
--- For a more general purpose function that handles all kinds of input, see 
--- 
--- @param ply Player
--- @param key number
...
--- Called when the context menu keybind (
--- See also 
--- 
...
--- Called when a player +use pickups up an entity. This will be called after the entity passes though 
--- See 
--- 
--- @param ply Player
--- @param ent Entity
...
--- This will not be called if player has a panel opened with keyboard input enabled, use 
--- 
--- @param ply Player
--- @param button number
...
--- Called when a weapon is dropped by a player via 
--- Also called when a weapon is removed from a player via 
--- See also 
--- The weapon's 
--- None
--- 
...
--- To prevent the player from changing teams, see 
--- 
--- @param ply Player
--- @param team number
...
--- Called when the player is killed by 
...
--- Primary usage of this hook is to prevent/allow weapon switching, 
--- 
--- @param player Player
...
--- Called right after the map has cleaned up (usually because 
--- See also 
--- 
...
--- Called after drawing the 3D skybox. This will not be called if skybox rendering was prevented via the 
--- See also 
--- 
...
--- Called right before the map cleans up (usually because 
--- See also 
--- 
...
--- Called before the 3D sky box is drawn. This will not be called for maps with no 3D skybox, or when the 3d skybox is disabled. (
--- See also 
--- 
--- @return boolean
...
--- Called before the view model has been drawn. This hook by default also calls this on weapons, so you can use 
--- You can use 
--- 
--- @param vm Entity
--- @param ply Player
...
--- Called before view models and entities with 
--- You can use 
--- 
...
--- Called to decide whether a pair of entities should collide with each other. This is only called if 
--- Where applicable, consider using 
--- 
--- @param ent1 Entity
--- @param ent2 Entity
--- @return boolean
...
--- Called to determine if the 
--- If you're using this hook to draw a player for a 
--- 
--- @param ply Player
--- @return boolean
...
--- This is basically a shared version of 
--- 
--- @param ply Player
--- @param ucmd CUserCmd
...
--- Called every frame on client and server. This will be the same as 
--- See 
--- 
...
--- Called when you are driving a vehicle. This hook works just like 
--- This hook is called before 
--- 
--- @param ply Player
--- @param veh Vehicle
