...
--- This function is available in server state(s)
--- 
--- Adds this --- Used in pathfinding via the --- More information can be found on the 
--- 
...
--- This function is available in server state(s)
--- 
--- Clears the open and closed lists for a new search.--- Used in pathfinding via the --- More information can be found on the 
--- 
...
--- This function is available in server state(s)
--- 
--- Returns a table of all the --- If an area has a one-way incoming connection to this --- See 
--- 
--- @return table
...
--- This function is available in server state(s)
--- 
--- Returns the cost from starting area this area when pathfinding. Set by --- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return number
...
--- This function is available in server state(s)
--- 
--- Returns a table of very bad hiding spots in this area.--- See also 
--- 
--- @return table
...
--- This function is available in server state(s)
--- 
--- Returns a table of good hiding spots in this area.--- See also 
--- 
--- @param type number
--- @return table
...
--- This function is available in server state(s)
--- 
--- Returns a table of all the --- If a --- See 
--- 
--- @return table
...
--- This function is available in server state(s)
--- 
--- Returns the total cost when passing from starting area to the goal area through this node. Set by --- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return number
...
--- This function is available in server state(s)
--- 
--- Returns whether this node is in the Closed List.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return boolean
...
--- This function is available in server state(s)
--- 
--- Returns whether this area is in the Open List.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return boolean
...
--- This function is available in server state(s)
--- 
--- Returns whether the Open List is empty or not.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return boolean
...
--- This function is available in server state(s)
--- 
--- Removes a CNavArea from the Open List with the lowest cost to traverse to from the starting node, and returns it.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @return CNavArea
...
--- This function is available in server state(s)
--- 
--- Removes this node from the Closed List.--- Used in pathfinding via the --- More information can be found on the 
--- 
...
--- This function is available in server state(s)
--- 
--- Sets the cost from starting area this area when pathfinding.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @param cost number
...
--- This function is available in server state(s)
--- 
--- Sets the total cost when passing from starting area to the goal area through this node.--- Used in pathfinding via the --- More information can be found on the 
--- 
--- @param cost number
...
--- This function is available in server state(s)
--- 
--- Moves this open list to appropriate position based on its --- Used in pathfinding via the --- More information can be found on the 
--- 
