...
--- Returns the 
--- This is a child of the root node of the 
--- 
--- @return Panel
...
--- Returns the access path of the file tree. This is 
--- See 
--- 
--- @return string
...
--- Sets the access path for the file tree. This is set to 
--- See 
--- 
--- @param path string
...
--- This accepts the same wildcards as 
--- 
--- @param filter string
...
--- Called to set up the 
--- The icon browser is used when in models mode. See 
--- 
--- @return boolean
