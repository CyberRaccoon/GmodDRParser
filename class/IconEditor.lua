...
--- Applies the top-down view camera settings for the model in the 
...
--- Applies the best camera settings for the model in the 
--- Called when a user clicks the 
--- 
...
--- Applies the front view camera settings for the model in the 
--- Called when a user clicks the 
--- 
...
--- Places the camera at the origin (0,0,0), relative to the entity, in the 
--- Called when a user clicks the 
--- 
...
--- This should be called immediately after setting the SpawnIcon with 
--- 
...
--- Applies the right side view camera settings for the model in the 
--- Called when a user clicks the 
--- 
...
--- Sets the editor's model and icon from an entity. Alternative to 
