...
--- This function is available in client state(s)
--- 
--- Returns whether the image inside the button should be stretched to fit it or not--- See 
--- 
--- @return boolean
...
--- This function is available in client state(s)
--- 
--- Sets whether the image inside the --- If set to false, the image will not be resized at all.
--- 
