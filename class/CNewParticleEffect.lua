...
--- This function is available in client state(s)
--- 
--- Forces the particle system to render using current rendering context.--- Can be used to render the particle system in vgui panels, etc.--- Used in conjunction with 
--- 
...
--- This function is available in client state(s)
--- 
--- Forces the particle system to stop automatically rendering.--- Used in conjunction with 
--- 
...
--- This function is available in client state(s)
--- 
--- Stops particle emission and destroys all particles instantly. Also detaches the particle effect from the entity it was attached to.--- Consider using 
--- 
